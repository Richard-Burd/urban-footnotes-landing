...
export default function Contact() {
  return (
    <div>
      ...
      <div className=" text-white roboto-font mx-4 rounded-[40px] text-xl sm:bg-[linear-gradient(to_right,rgba(77,61,87,0.3),rgba(45,19,67,1.0))] md:p-6 md:text-2xl lg:mx-32">
        <p className="mb-4">
