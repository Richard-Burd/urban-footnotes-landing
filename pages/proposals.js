...
const CARD_LIGHT =
  "bg-[linear-gradient(to_right,rgba(178,120,120,0.15),rgba(113,22,21,0.35))]";
const CARD_DARK =
  "bg-[linear-gradient(to_right,rgba(113,22,21,0.30),rgba(80,15,15,0.55))]";
const HEADING =
  "roboto-font mb-3 text-3xl font-bold text-title-text-product title-shadow-product pb-4";
const BODY = "text-[clamp(1.05rem,2.5vw,1.2rem)] leading-relaxed text-gray-100";
const HIGH_FID_DEV_PROPOSAL = "assets/proposals/high-fid-dev-prop.png";
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 md:px-10">
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 space-y-5 lg:col-span-7">
            <section className="overflow-hidden rounded-[10px]">
              <div className={`${CARD_LIGHT} p-5 md:p-7`}>
                ...
                <p className={BODY}>
                  ...
                  reports show how a property could be developed so as to
                  maximize walkability for residents living in the immediate
                  vicinity. These designs are almost always mixed-use complexes
            ...
            <section className="overflow-hidden rounded-[10px]">
              <div className={`${CARD_DARK} p-5 md:p-7`}>
                ...
                <p className={BODY}>
                  Development proposals should be thought of as a tool for
                  parcel optimization & discovery. They can be used to make a
                  case for rezoning, conditional use permit, or a mixed-use
                  overlay. City planners may be more flexible on granting these
                  if a case can be made for an overall public good, which
                  development proposals aim to demonstrate.
                </p>
              </div>
            </section>
            ...
            <section className="overflow-hidden rounded-[10px]">
              <div className={`${CARD_LIGHT} p-5 md:p-7`}>
                ...
                <p className={BODY}>
                  ...
                  drawings. They show schematic floor plans broken down by
                  occupancy type per floor. Basic IBC compliant egress schemas
                  are included as well. We can provide varying levels of
                  fidelity in terms of 3D modeling and presentation to meet your
                  specific needs.
                </p>
              </div>
            </section>
            ...
            <section className="overflow-hidden rounded-[10px]">
              <div className={`${CARD_DARK} p-5 md:p-7`}>
                ...
                <p className={`${BODY} mb-4`}>
                  Our team has extensive experience in both
                  architecture/building construction as well as environmental &
                  urban solutions. We leverage this experience to deliver a
                  unique product. That said, we may rely on you for certain
                  due-diligence requirements unique to your city or region.
                </p>
                <p className={`${BODY} mb-4`}>
                  If you have a property address or parcel you would like us to
                  look at, please feel free to contact us so we can discuss your
                  project.
                </p>
                <p className="text-lg">
          ...
          <div className="col-span-12 space-y-5 lg:col-span-5">
            <section className="overflow-hidden rounded-[10px]">
              <div className={`${CARD_DARK} p-5 md:p-7`}>
                <h2 className={HEADING}>Report Examples:</h2>
                <ProductSample
                ...
                <ProductSample
                  ...
                  walkabilityScore={26}
                  pdfPath="doc-coral-gables-fl-development-proposal.7.2.pdf"
                />
              </div>
            </section>
          </div>
