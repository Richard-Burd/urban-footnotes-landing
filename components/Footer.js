  ...
  return (
    <div id="ucs-footer-label">
      <div className="m-3 justify-center pt-1 sm:m-8 sm:pt-4 lg:flex xl:m-8 xl:pt-8">
        ...
        <div className="flex items-center justify-center lg:pl-8">
          <a
            ...
            aria-label="Visit Urban Cruise Ship website (opens in new tab)"
            target="_blank"
      ...
      <div>
        ...
        <a
          href="mailto:contact@urbancruiseship.org"
          className="roboto-font text-1xl block pb-10 text-center tracking-wider text-stone-300"
        >
